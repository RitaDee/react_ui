...
- Link to [BackEnd APP](git@github.com:RitaDee/rails-api.git)
...
```sh
git clone git@github.com:RitaDee/react_ui.git
...
Feel free to check the [issues page](https://github.com/RitaDee/rails-api/issues).
